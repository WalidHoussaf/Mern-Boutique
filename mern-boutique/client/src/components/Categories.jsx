...
// Define the static category data - images will still be used from here
const categoryData = [
  {
    id: 1,
    name: "Women",
  ...
  return (
    <section className="py-16 bg-neutral-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          {/* Top Selection badge - styled as in FeaturedProducts */}
          ...
          {/* Divider that matches FeaturedProducts */}
        ...
        >
          {categoriesWithCounts.map((category) => (
            ...
            >
              {/* Category Image with blur-up loading effect */}
