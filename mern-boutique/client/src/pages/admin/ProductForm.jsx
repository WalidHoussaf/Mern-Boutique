...
const ProductForm = () => {
    ...
    if (productId && productId !== 'new') {
      const fetchProduct = async () => {
        ...
        try {
          ...
          console.log('Loaded product with rating:', productData.rating, typeof productData.rating);
  ...
  const handleChange = (e) => {
    ...
    if (name === 'rating') {
      ...
      console.log('Setting rating to:', ratingValue, typeof ratingValue);
      setProduct({
        ...product,
        [name]: ratingValue
      });
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      // Process each file to a base64 string or upload to server
      ...
      setProduct({
        ...product,
        images: [...product.images, ...imageResults]
      });
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('Submitting product with rating:', productData.rating, typeof productData.rating);
    ...
    try {
      ...
      if (productId && productId !== 'new') {
        ...
        console.log('Updated product rating:', response.data.rating, typeof response.data.rating);
        ...
        console.log('Created product rating:', response.data.rating, typeof response.data.rating);
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-6">
              ...
              <div>
                <label htmlFor="brand" className="block text-sm font-medium text-gray-700 mb-1 flex items-center">
              ...
              <div>
                <label htmlFor="newSubCategory" className="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
