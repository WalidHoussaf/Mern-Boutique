  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-prata text-secondary mb-2">{t('your_cart')}</h1>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                        ...
                        <div className="col-span-1 md:col-span-6">
                          <div className="flex items-center">
                            ...
                            <div className="ml-6">
                              <h3 className="font-medium text-gray-900 hover:text-primary transition-colors cursor-pointer text-lg" 
                                  onClick={() => navigate(`/product/${product._id}`)}>
                                {product.name}
                              </h3>
                              <div className="flex flex-wrap mt-2 gap-2">
                                <span className="px-2.5 py-1 bg-gray-100 text-sm rounded-md text-gray-600">{product.category}</span>
                                {product.size && (
                                  <span className="px-2.5 py-1 bg-primary/10 text-sm rounded-md text-primary font-medium">
                                    {t('size')}: {product.size}
                                  </span>
                                )}
                              </div>
                        ...
                        <div className="col-span-1 md:col-span-2">
                          <div className="flex items-center border rounded-lg w-full max-w-[120px]">
                            <button 
                              ...
                              className="flex-1 flex justify-center items-center h-10 text-gray-500 hover:text-primary transition-colors"
                            >
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 12H4" />
                              </svg>
                            </button>
                            <span className="flex-1 flex justify-center items-center h-10 border-x text-gray-700">{product.quantity}</span>
                            <button 
                              onClick={() => handleQuantityChange(product.cartItemKey, product.quantity + 1)}
                              className="flex-1 flex justify-center items-center h-10 text-gray-500 hover:text-primary transition-colors"
                            >
            ...
            <div className="bg-white rounded-xl shadow-md p-6 md:p-8 border border-gray-100 sticky top-20">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-800">{shipping === 0 ? t('free') : formatPrice(shipping)}</span>
                </div>
              ...
              <div className="mt-6 mb-8">
                ...
                <div className="flex justify-center space-x-3">
                  {/* Payment icons */}
                  <img src="/visa-svg.svg" alt="Visa" className="h-8 w-auto object-contain grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all" />
              ...
              <motion.button 
                ...
                className="w-full py-4 bg-primary text-white font-medium rounded-lg shadow-sm hover:bg-primary-dark hover:shadow transition-all duration-200 flex items-center justify-center"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
