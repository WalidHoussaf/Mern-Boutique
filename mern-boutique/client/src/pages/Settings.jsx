...
const Settings = () => {
  ...
  // Debug effect to monitor currency changes
  useEffect(() => {
    console.log('Settings component - currency context value:', currency);
    console.log('Settings component - settings.currency value:', settings.currency);
  ...
  useEffect(() => {
    ...
    if (currency !== settings.currency) {
      console.log('Updating settings currency from context:', currency);
      setSettings(prev => ({
        ...prev,
        currency: currency
      }));
    ...
    if (language !== settings.language) {
      console.log('Updating settings language from context:', language);
      setSettings(prev => ({
        ...prev,
        language: language
      }));
  ...
  useEffect(() => {
    if (!isAuthenticated()) {
      ...
      toast.info('Please log in to access your settings');
      return;
    }
  ...
  const handleCurrencyChange = (currencySymbol) => {
    console.log(`Settings: handleCurrencyChange called with ${currencySymbol}`);
  ...
  const handleLanguageChange = (languageValue) => {
    console.log(`Settings: handleLanguageChange called with ${languageValue}`);
